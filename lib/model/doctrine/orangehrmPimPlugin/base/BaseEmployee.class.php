 ...
 * @property Doctrine_Collection $PurchaseRequestMaster
 ...
 * @method Doctrine_Collection       getPurchaseRequestMaster()      Returns the current record's "PurchaseRequestMaster" collection
 ...
 * @method Employee                  setPurchaseRequest()            Sets the current record's "PurchaseRequest" collection
 * @method Employee                  setPurchaseOrder()              Sets the current record's "PurchaseOrder" collection
 * @method Employee                  setPurchaseRequestMaster()      Sets the current record's "PurchaseRequestMaster" collection
...
abstract class BaseEmployee extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('PurchaseRequestMaster', array(
             'local' => 'emp_number',
             'foreign' => 'employee_number'));
