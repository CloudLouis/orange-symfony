 ...
 *
 */
class RequestReportForm extends BaseForm {
    ...
    public function configure() {
        ...
        $choices= ['Pending Request', 'Approved Request', 'Canceled Request'];
        ...
        $this->widgetSchema->setNameFormat('request_list[%s]');
    }
    ...
    public function save() {
        ...
        $regM = $this->getrequestSubmissionService()->getRequestByTransactionNumber($this->getValue('transaction_number'));

        foreach($regM as $requested){
            $master = $this->getrequestSubmissionService()->getRequestMaster($requested->getMasterId());
