...
class RequestReportRejectionHeaderFactory extends ohrmListConfigurationFactory {
	...
	protected function init() {
        ...
        $header4->populateFromArray(array(
		    ...
		    'width' => '20%',
		    'isSortable' => true,
		    'sortField' => 'rejection_reason',
		    'elementType' => 'label',
		    'elementProperty' => array('getter' =>'getRejectionReason'),
		...
		$this->headers = array($header7,$header1, $header2, $header3, $header5, $header9, $header6, $header8, $header4);
	}
