...
class OrderReportHeaderFactory extends ohrmListConfigurationFactory {
	...
	protected function init() {
		...
		$this->headers = array($header1, $header2, $header3, $header5, $header6, $header7, $header8, $header9, $header10, $header4, $header11);
	}
