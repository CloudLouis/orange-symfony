...
class RequestReportHeaderFactory extends ohrmListConfigurationFactory {
	...
	protected function init() {
		...
		$this->headers = array($header7,$header1, $header2, $header3,$header4,$header5, $header9, $header6, $header8, $header10);
	}
