...
class OrderReportRejectionHeaderFactory extends ohrmListConfigurationFactory {
	...
	protected function init() {
		...
		$header7->populateFromArray(array(
		    ...
		    'width' => '10%',
		    'isSortable' => true,
		    'sortField' => 'cancellation_reason',
		    'elementType' => 'label',
		    'elementProperty' => array('getter' =>'getCancellationReason'),
		    
		));


		$this->headers = array($header1, $header2, $header3, $header6, $header9, $header10, $header4, $header7);
	}
