...
class ModuleForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
            ...
            'purchasing' => new sfWidgetFormInputCheckbox(array(), array('class' => 'checkbox', 'value' => 'on')),
        ));        
        ...
        $this->setValidators(array(
            ...
            'purchasing' => new sfValidatorPass()
        ));
    ...
    protected function _getDefaultValues() {
        ...
        $modules = array('admin', 'pim', 'leave', 'time', 'recruitment', 'performance', 'directory', 'purchasing');
